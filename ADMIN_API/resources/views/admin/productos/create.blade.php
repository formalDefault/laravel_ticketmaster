...
<h1>CREAR</h1>
<form class="row g-3 needs-validation" method="POST" action="/productos" 
    ...
    <div class="col-md-12">
        ...
        <input type="text" class="form-control" id="validationCustom02" name="supplier_id" required>
        <div class="valid-feedback">
            Looks good!
        </div>
        <div class="invalid-feedback">
    ...
    <div class="col-md-12">
        ...
        <input type="text" class="form-control" id="validationCustom02" name="categorie_id" required>
        <div class="valid-feedback">
            Looks good!
        </div>
        <div class="invalid-feedback">
